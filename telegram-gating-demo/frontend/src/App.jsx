...
import {
  ...
  DarkTheme,
  LightTheme
} from './lib/passport-embed-mock'; // Replace with '@human.tech/passport-embed' when available
import './App.css';
...
function App() {
  ...
  const { score, isPassing, loading, error } = usePassportScore({
    apiKey: import.meta.env.VITE_PASSPORT_API_KEY || 'demo-api-key',
    scorerId: import.meta.env.VITE_PASSPORT_SCORER_ID || 'demo-scorer-id',
    address: address,
  });
          ...
          <div className="connect-section">
            ...
            <div className="info-box">
              ...
              <p>
                ...
                <a href="https://passport.gitcoin.co" target="_blank" rel="noopener noreferrer">
                  passport.gitcoin.co
                </a>{' '}
          ...
          {backendStatus === 'failed' && (
            <div className="status-box error">
              ...
              <div className="improvement-tips">
                ...
                <ol>
                  <li>Visit <a href="https://passport.gitcoin.co" target="_blank" rel="noopener noreferrer">passport.gitcoin.co</a></li>
