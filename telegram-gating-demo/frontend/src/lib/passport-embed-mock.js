...
export const usePassportScore = ({ apiKey, scorerId, address }) => {
  ...
  useEffect(() => {
    ...
    const fetchScore = async () => {
      ...
      try {
        // In a real implementation, this would call the Passport API
          ...
          {!isPassing && (
            <div style={{ marginTop: '15px' }}>
              ...
              <p style={{ fontSize: '14px', color: theme.secondary }}>
                Visit <a href="https://passport.gitcoin.co" target="_blank" rel="noopener noreferrer" style={{ color: theme.primary }}>
                  passport.gitcoin.co
