...
- [Individual Verifications Endpoints](api/individual-verifications-endpoints.md) - Verified API endpoints for sybil resistance, Snapshot strategies
...
- [Package Manager](conventions/package-manager.md) - Must use pnpm, not npm
- [MDX Components](conventions/mdx-components.md) - Standard Nextra components (Cards, Callout)

## Dependencies

- [Project Dependencies](dependencies/project-dependencies.md) - Core packages and versions
...
- [PR Workflow](workflows/pr-workflow.md) - Always use PRs, never push directly to main
