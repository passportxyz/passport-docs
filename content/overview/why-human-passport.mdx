...
**Human Passport is a Sybil resistance protocol and identity verification platform. Users can prove their unique humanity through multiple verification methods: [Stamps](/building-with-passport/stamps) aggregate identity attestations from web2 and web3 authenticators, [Models](/building-with-passport/models) provide frictionless ML-powered verification, and [Individual Verifications](/building-with-passport/individual-verifications) offer privacy-preserving KYC, phone, biometrics, and AML checks using zero-knowledge proofs.**
