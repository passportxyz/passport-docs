...
We added a new custom Stamp type to [Custom Passport](/building-with-passport/stamps/custom-passport): **NFTHolder**. This Stamp enables partners to verify on-chain token ownership across multiple smart contracts and chains. Partners can define which contracts qualify — including NFTs, POAPs, OATs, or any ERC-721/ERC-1155 token — and users who hold at least one matching token will receive points. The NFTHolder Stamp supports 20 chains including Ethereum, Optimism, Base, Arbitrum, Polygon, Linea, Scroll, and more.
