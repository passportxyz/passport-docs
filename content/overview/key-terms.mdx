...
A zero-knowledge proof is a cryptographic method that allows one party to prove to another that a statement is true without revealing any additional information beyond the validity of the statement itself. In the context of Human Passport, zero-knowledge proofs enable users to prove they have passed identity verification (such as KYC or sanctions checks) without exposing their personal data to applications. This technology powers [Individual Verifications](/building-with-passport/individual-verifications), allowing privacy-preserving identity checks.
