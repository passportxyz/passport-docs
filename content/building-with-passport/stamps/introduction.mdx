...
description: An overview of Passport Stamps, the ID verification aggregate tool
---
...
<Cards>
  <Cards.Card title="Generate API Key and Scorer ID" href="/building-with-passport/stamps/passport-api/getting-access" />
</Cards>

## What are Stamps?

Passport Stamps is an aggregate, real-time verification tool that can enable users to prove their unique humanity using a variety of different verification methods, and for developers to access these humanity proofs via the [Stamps API](/building-with-passport/stamps/passport-api) or [smart contracts](/building-with-passport/stamps/smart-contracts).
...
Users who hold multiple wallets can link them under a single canonical identity using [account linking](/building-with-passport/stamps/major-concepts/account-linking). When addresses are linked, their Stamps and scores are unified, and the API includes fields for sybil deduplication across linked wallets.
...
* **[Stamps API v2](/building-with-passport/stamps/passport-api):** Retrieves the Stamp-based Unique Humanity Score and associated metadata for a specified address. 
* **[Passport Smart Contracts](/building-with-passport/stamps/smart-contracts):** Interacts with a blockchain to retrieve Stamp-based Unique Humanity Scores associated with a specific address. 
...
* **[Passport Embed](/building-with-passport/embed):** A widget that can be embedded on a website or app to allow users to verify their identity.
* **[Custom Passport](/building-with-passport/stamps/custom-passport):** A dashboard that can be customized to the unique needs of your ecosystem.
...
<Cards>
  <Cards.Card title="Overview" href="/building-with-passport/stamps/passport-api" />
  <Cards.Card title="Get access" href="/building-with-passport/stamps/passport-api/getting-access" />
  <Cards.Card title="Quick start" href="/building-with-passport/stamps/passport-api/quick-start-guide" />
  <Cards.Card title="API reference" href="/building-with-passport/stamps/passport-api/api-reference" />
</Cards>
...
<Cards>
  <Cards.Card title="Passport Embed" href="/building-with-passport/embed" />
</Cards>
...
<Cards>
  <Cards.Card title="Custom Passport" href="/building-with-passport/custom-passport" />
</Cards>
...
<Cards>
  <Cards.Card title="Onchain Passport" href="/building-with-passport/stamps/smart-contracts" />
</Cards>
...
- [Get to "Hello World" with Stamps API v2](/building-with-passport/stamps/passport-api/quick-start-guide)
