...
If you'd prefer to learn by doing, please visit our [API playground](https://passport-api-playground.vercel.app) to see the changes in action.
...
4. [Unified Scorer types](#unified-scorer-types)
5. [Additional Stamp data in score payload](#additional-stamp-data-in-score-payload)
...
5. Thoroughly test your application to ensure all changes work as expected.
