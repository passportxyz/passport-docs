...
```json filename="Sample response"
{
    ...
    "threshold": "20",
    "error": null,
    "canonical_address": "0x2C1E111d7C3adc823B5fA3af3f07EB62831C3c5",
    "linked_addresses": ["0x2C1E111d7C3adc823B5fA3af3f07EB62831C3c5"],
...
<Callout type="info">
**Linked accounts:** The response includes `canonical_address`, `linked_addresses`, and `eligible_for_campaign` fields. If the queried address is part of a linked account set, the score and Stamps reflect the unified data across all linked addresses. The `eligible_for_campaign` field indicates whether this address can participate in a campaign, or whether another linked address has already claimed access. Learn more about [account linking](/building-with-passport/stamps/major-concepts/account-linking).
</Callout>
