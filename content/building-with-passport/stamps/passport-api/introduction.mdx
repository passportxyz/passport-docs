...
Users can prove their humanity using Passport Stamps by visiting the [Passport App](https://app.passport.xyz) and completing a verification flow, or by using the [Passport Embed](/building-with-passport/embed) widget on a partner website or dApp.

<Callout type="info">
**Linked accounts:** The Stamps API supports linked accounts, which unify Stamps and scores across multiple wallet addresses under a single canonical identity. When you query any linked address, you receive the combined score and Stamp data for the entire set. Learn more about [account linking](/building-with-passport/stamps/major-concepts/account-linking).
</Callout>
