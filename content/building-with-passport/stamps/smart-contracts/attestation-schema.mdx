...
To access a user's attestation data, please use the decoder contract, which is documented via the [contract reference](/building-with-passport/stamps/smart-contracts/contract-reference#decoder-contract)
