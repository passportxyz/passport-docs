...
There are some parts of this boilerplate code that might look unfamiliar even if you have been through the other [tutorials](/building-with-passport/stamps/passport-api-v1/tutorials) on this site. This is because there is some specific setup required to use smart contracts on the backend.
...
![Onchain stamp explorer 1](/onchain-stamp-explorer-1.png)

![Onchain stamp explorer 2](/onchain-stamp-explorer-2.png)

![Onchain stamp explorer 3](/onchain-stamp-explorer-3.png)
