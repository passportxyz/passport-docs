...
| Curate Stamps and weights                | Remove any Stamps or credentials that don’t make sense for your ecosystem, and adjust the remaining [credential weights](./major-concepts/credential-map-and-weights) to better reflect your ecosystem’s needs.                                                                                                                                                                                                                                   |
...
| Create your own Stamps:<br />NFTHolder     | Verify on-chain token ownership across multiple contracts and chains. Partners define which smart contracts qualify — including NFTs, POAPs, OATs, or any ERC-721/ERC-1155 token. Users who hold at least one matching token receive points. Supports 20 chains including Ethereum, Optimism, Base, Arbitrum, Polygon, Linea, Scroll, and more. |
...
If you would like to create a Stamp that verifies on-chain token ownership, please provide us with the smart contract addresses and chain IDs for the tokens you want to verify. This can include NFTs, POAPs, OATs, or any ERC-721/ERC-1155 token.

A user qualifies if they hold at least one token across any of the listed contracts. You can specify up to 20 contracts per Stamp, spanning any of the supported chains:

Ethereum, Optimism, BNB Chain, Gnosis, Polygon, Fantom, zkSync, Polygon zkEVM, Sei, Mantle, ZetaChain, Base, Arbitrum One, Arbitrum Nova, Celo, Avalanche, Linea, Blast, Scroll.
