...
Read more about Sybil defense on the [blog](https://passport.human.tech/blog).
...
Human Passport is already protecting many real world applications! You can read about active integrations on the [Active Integrations](/overview/active-integrations) page and on the [blog](https://passport.human.tech/blog).

### Where to go from here?

* Read more about [how Passport works](/overview/why-human-passport)
