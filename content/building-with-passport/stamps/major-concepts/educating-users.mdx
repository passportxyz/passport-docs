...
3. You can follow our simple [quick start guide](/building-with-passport/stamps/passport-api/quick-start-guide) to quickly and easily start defending your app from Sybils!
...
Finally, you might not necessarily want to automatically gate access based on Passport scores or Stamps. Perhaps you want to display Stamp and score information about each user so platform administrators or end users can make real-time decisions based on the user's trustworthiness or reputation. For example, you might have to determine an honest user from several impersonator accounts. Quick access to Stamp and score data would give you a strong signal about who is the genuine user. There is a guide for displaying Stamp and score data in your app's UI in our [API reference](/building-with-passport/stamps/passport-api/api-reference).

Read more on [How Passport works](/overview/).

Start building using our [quick start guide](/building-with-passport/stamps/passport-api/quick-start-guide).
...
<Cards>
<Cards.Card title="Building Reputation on {r}elinkd" href="https://www.gitcoin.co/blog/building-reputation-on-r-elinkd" />
<Cards.Card title="Guild.xyz and Gitcoin Passport Partner to Stop Bots and Sybil Attackers" href="https://www.gitcoin.co/blog/guild-xyz-and-gitcoin-passport-partner" />
<Cards.Card title="Bankless Academy - A Gitcoin Passport Case Study" href="https://www.gitcoin.co/blog/bankless-academy-a-gitcoin-passport-case-study" />
<Cards.Card title="Strengthening CyberConnect's Loyalty Program with Gitcoin Passport" href="https://www.gitcoin.co/blog/gitcoin-passoort-cyberconnect-case-study" />
</Cards>
