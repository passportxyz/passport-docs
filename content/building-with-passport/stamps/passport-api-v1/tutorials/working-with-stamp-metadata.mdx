---
title: Working with Stamp metadata (Retired)
description: How to retrieve, handle and display Stamp metadata in a simple Nextjs app - This API version is retired
noindex: true
---
...
![Stamp logo examples](/stamp-logo-examples.png)
...
```sh
curl --request GET 'https://api.passport.xyz/registry/stamps/{your-address}?include_metadata=true' \
...
![Stamp collector app showing stamps](/stamp-collector-app-showing-stamps.png)
