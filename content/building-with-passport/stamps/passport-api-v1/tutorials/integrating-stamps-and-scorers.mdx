---
title: Integrating Stamps and Scores (Retired)
description: Tutorial covering how to use Stamp and Score data in your apps - This API version is retired
noindex: true
---
...
Now, create a new file in `passport-app`/ and add the following to set the Stamps API Key and Scorer ID values (if you need a reminder of how to get the API key and Scorer values, revisit the Quick Start guide):
...
![Trusted user app part 1](/trusted-user-app-pt1.png)
...
![Trusted user app part 2](/trusted-user-app-2.png)
