...
<Callout type="info">
**Linked accounts:** API responses include `canonical_address`, `linked_addresses`, and `eligible_for_campaign` fields. If the queried address is part of a linked account set, the returned score and Stamps reflect the unified data across all linked wallets. Learn more about [account linking](/building-with-passport/stamps/major-concepts/account-linking).
</Callout>
