...
**[Try the Embed Playground](https://passport-embed-playground.vercel.app)** — Configure the widget visually, preview it in real-time, and copy ready-to-use code for your project.
...
**[Open the Embed Playground](https://passport-embed-playground.vercel.app)** to configure themes, test different scenarios, and generate code — all without writing any code first.
