...
description: Passport Embed lets websites integrate Human Passport's Stamps-based verification directly on their website or app, so users are not redirected elsewhere.
---
...
Passport Embed lets websites integrate Human Passport's [Stamps-based verification](/building-with-passport/stamps) directly on their website or app, so users are not redirected elsewhere​. In essence, Passport Embed provides an on-site component for proof of humanity, ensuring that communities and applications remain Sybil-resistant (protected from fake or duplicate accounts) without adding user friction.
...
* **Key Differentiators:** Passport Embed is a privacy-preserving alternative to traditional KYC or CAPTCHA. It uses verifiable credentials ("Stamps") to calculate a humanity score, so site owners never receive sensitive personal info – only a score or pass/fail status. Unlike other solutions, Passport Embed is decentralized and user-first​, meaning users maintain control over their data and can prove their humanity without sacrificing anonymity.

Overall, the Passport Embed component brings the power of Human Passport's identity verification directly into your application. It's designed for both developers and decision-makers who want to boost security and trust in their platform while keeping the user experience seamless and on-brand.

<Callout type="info">
**Please Note:**<br />
Embed supports both the [Passport Stamps verification flow](/building-with-passport/stamps/passport-api) and [Individual Verifications](/building-with-passport/individual-verifications/introduction) — zk KYC, zk Phone, zk Biometrics, and zk Proof of Clean Hands.<br /><br />
Join our [Developer Telegram group](https://t.me/+Mcp9RsRV7tVmYjZh) to stay updated on the latest features and get support.
</Callout>

## User flow

The user flow for Passport Embed is as follows:
...
The component can be [customized](/building-with-passport/embed/customization) in a number of ways, including:
...
* [Getting access to Passport Embed](/building-with-passport/embed/getting-access)
* [Quick start guide](/building-with-passport/embed/quick-start-guide)
* [Tutorial: Protecting Sensitive Programs with Passport Embed](/building-with-passport/embed/tutorials/protecting-sensitive-programs-with-passport-embed)
* [Component reference](/building-with-passport/embed/component-reference)
