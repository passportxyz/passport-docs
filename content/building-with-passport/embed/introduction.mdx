...
**[Try the Embed Playground](https://embed-playground.passport.xyz)** — Configure the widget visually, preview it in real-time, and copy ready-to-use code for your project.
