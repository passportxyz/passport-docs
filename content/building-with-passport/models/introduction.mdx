...
<Cards>
  <Cards.Card title="Generate API Key and Scorer ID" href="/building-with-passport/models/getting-access" />
</Cards>
...
2. **Data analysis:** Analyzing a set of wallet addresses against the Passport Model Based Detection score to identify which wallets are likely Humans or Sybils. You can also get in contact with us to have our team perform more in-depth data analysis around a list of wallet addresses by filling out [this form](https://tally.so/r/3X81KL).
...
You can retrieve a model-based score with a simple API request. Try it out using our [API playground](https://passport-api-playground.vercel.app).

* [Try the API playground](https://passport-api-playground.vercel.app)
* [Review the API Reference](/building-with-passport/models/api-reference)
* [View available models and recommended score thresholds](/building-with-passport/models/available-models)
* [Learn about double verification with Models API and Stamps API](/building-with-passport/models/tutorials/double-verification)
