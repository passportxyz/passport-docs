...
<Callout type="info">
Looking to query attestations directly? See [Attestation Protocols](/building-with-passport/individual-verifications/major-concepts/attestation-protocols) for Sign Protocol schema documentation and direct query methods.
</Callout>
...
<Callout type="info">
Custom action IDs are available for specific use cases. [Contact us](https://tally.so/r/3X81KL) to discuss your requirements.
</Callout>
...
<Callout type="info">
We recommend using the default action ID `123456789`. [Contact us](https://tally.so/r/3X81KL) if you need a custom action ID.
</Callout>
...
<Callout type="info">
**Stellar** uses SBTs via Soroban smart contracts instead of the REST API. See the [Stellar Integration](/building-with-passport/individual-verifications/supported-chains/stellar) page for Stellar-specific querying methods.
</Callout>

---

For more details on integration patterns, see the [Introduction](/building-with-passport/individual-verifications/introduction).
