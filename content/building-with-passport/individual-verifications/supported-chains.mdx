...
| Chain | Gov ID (KYC) | Gov ID (NFC Passport) | Phone | Biometrics | Clean Hands |
|-------|-------------|----------------------|-------|------------|-------------|
| **Optimism** | ✅ | ✅ | ✅ | ✅ | ✅ |
| **Stellar** | ✅ | - | ✅ | - | - |

<Callout type="info">
**NFC Passport** verification (via zkPassport) is currently available on **Optimism only**. Traditional KYC-based Gov ID remains available on both Optimism and Stellar.
</Callout>
...
- Government ID — KYC (traditional) and NFC Passport (zkPassport)
- Phone
- Biometrics
