...
| Chain | Gov ID | Phone | Biometrics | Clean Hands | ePassport |
|-------|--------|-------|------------|-------------|-----------|
| **Optimism** | ✅ | ✅ | ✅ | ✅ | - |
| **Base** | - | - | ✅ | ✅ | - |
| **Stellar** | ✅ | ✅ | - | - | ✅ |
...
Individual Verifications support Stellar via Soroban smart contracts for Government ID, Phone, and ePassport verifications.
...
<Callout type="info">
On EVM chains (Optimism, Base), attestations via Sign Protocol are the recommended integration. On Stellar, SBTs via Soroban are the current method. See the [Stellar Integration](/building-with-passport/individual-verifications/supported-chains/stellar) page for complete code examples and integration details.
</Callout>
...
| Stellar integration | [Stellar Integration](/building-with-passport/individual-verifications/supported-chains/stellar) |
...
<Cards>
  <Cards.Card title="Stellar Integration" href="/building-with-passport/individual-verifications/supported-chains/stellar" />
