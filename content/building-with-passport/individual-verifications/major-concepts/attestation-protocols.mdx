...
| **Government ID (NFC Passport)** | `0x14c3513390f8a03993c848621b1840d58c27fd50bbddba73265e22d17b0b747e` |
...
| **Government ID (NFC Passport)** | `0x231c6ff490cf3282131a301f0b7dad3dcdfa769d912e01941a80c92dd750df96` |
...
| **Government ID (NFC Passport)** | `0x0e25ddc8d050bcb861cfc8c57768e226b3072b6bcc2683368181626e1a07c97f` |
...
// Gov ID has two valid verification methods: KYC and NFC Passport (zkPassport).
// Both share sybil resistance — a user can only verify via one method.
const GOV_ID_CIRCUITS = {
  kyc: {
    circuitId: "0x729d660e1c02e4e419745e617d643f897a538673ccf1051e093bbfa58b0a120b",
    issuer: "0x03fae82f38bf01d9799d57fdda64fad4ac44e4c2c2f16c5bf8e1873d0a3e1993",
  },
  nfcPassport: {
    circuitId: "0x14c3513390f8a03993c848621b1840d58c27fd50bbddba73265e22d17b0b747e",
    issuer: "0x231c6ff490cf3282131a301f0b7dad3dcdfa769d912e01941a80c92dd750df96",
  },
};
...
function validateGovIdAttestation(attestation: any): AttestationValidation {
  ...
  // Match against both Gov ID circuit types
  const method = Object.entries(GOV_ID_CIRCUITS).find(
    ([, config]) => config.circuitId === circuitId
  );
  ...
  // Validate issuer matches the circuit type
  if (issuer.toHexString() !== config.issuer) {
    return { isValid: false, error: "Invalid issuer" };
  }

  return { isValid: true, method: methodName as "kyc" | "nfcPassport" };
}
```
