---
title: Why Passport XYZ
description: A short explanation of why we are building Passport XYZ.
---

# Why Passport XYZ?

**Passport XYZ is a sybil resistance protocol and identity aggregation dApp built on the Ceramic Network. Users can collect various identity attestations, called "Stamps", from web2 and web3 authenticators all in one place.**
...
**That's where Passport XYZ comes in.**
