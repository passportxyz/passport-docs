...
Passport scores are a metric designed to increase as the evidence that a user is a real individual human accumulates. 
There is a large set of criteria that a user can satisfy, such as :

- Ownership of a Twitter, Google or Facebook account with certain numbers of followers or interactions
- Web3 activities such as ETH or NFT ownership
- Participation in Gitcoin rounds
- Staking GTC token in a smart contract
...
Passport score between 16 - 20 ➡️ base rewards *2
Passport score over 21 ➡️ base reward * 3
```
