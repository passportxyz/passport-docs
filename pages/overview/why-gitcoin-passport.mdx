---
title: Why Gitcoin Passport
description: A short explanation of why we are building Gitcoin Passport.
---
...
We originally created Passport for Gitcoin's own needs: to [defend Gitcoin's Grants program from sybil attacks](https://youtu.be/v1Dm7FI2AdU) so that only real people can help decide which projects receive funds from a shared matching pool.
