...
This page contains a condensed list of active integrations along with links to guides detailing how to leverage Passport within each ecosystem.

To find a complete list of ecosystem partners, please visit the following page:

<Cards>
  <Card title="Passport Ecosystem Partners" href="https://passport.xyz/ecosystem" />
</Cards>
...
Previous campaigns that have used Passport:
* zkSync
* LetsGrowDAO
...
<Cards>
  <Card title="Using Passport with Galxe" href="https://help.galxe.com/en/articles/8568679-customizing-campaigns-with-participation-requirements" />
</Cards>
...
While we do list our full list of integration partners on our [ecosystem page](https://passport.xyz/ecosystem), we want to continue to build out this page with links to partners who have instructions on how to use Passport within their ecosystem. 
