...
While Passport API v1 enabled you to pick between two different [types of Scorers](../passport-api-v1/getting-access#types-of-scorers), this concept is no longer important in Passport API v2 since both the numerical and binary scores deliver within the [payload](data-dictionary). 
