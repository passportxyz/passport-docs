...
Typically, the score is compared to a [threshold](../../major-concepts/scoring-thresholds) that determines whether a user is given access to some resource.
...
You can also ask questions in our [developer support channel on Discord](https://discord.com/channels/562828676480237578/986222591096279040).
