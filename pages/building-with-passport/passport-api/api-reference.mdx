...
| ------------------ | -------- | ------------------------------------------------------------------------------------------------------------ |
| `created_at`       | yes      | Specified time that you want to retrieve the score for. <br /><br />ISO 8601 (`YYYY-MM-DD` or `YYYY-MM-DDThh:mm:ss.sssZ`)   |
...
The `stamp_scores` struct is not available via the historical score endpoint before December 29th, 2023.
