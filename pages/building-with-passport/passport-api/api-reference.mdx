...
<Callout type="info">
**Please note:**<br /><br />This page includes details on v1 of the Passport API. [Passport API v2](/building-with-passport/passport-api-v2/api-reference). both simplifies and adds key functionality that isn't available with v1 of the API. Because of this, it is recommended for you to use Passport API v2 moving forward.<br /><br />We have not announced any deprecation or retirement timelines for v1 yet, but plan to provide more details before the end of 2024.
</Callout>
