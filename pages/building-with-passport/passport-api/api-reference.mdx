...
The `stamp_scores` struct will include the weight of each verified Stamp at the time of the most recent score previous to the specified `created_at` date. This struct is not available via the historical score endpoint before December 29th, 2023.
