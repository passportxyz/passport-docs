...
## The base URL
In August 2024, the Passport workstream spun out of Gitcoin. 
...
To prevent multiple Passports from verifying the same credential (enhancing security against Sybil attacks), Stamps are [deduplicated](../major-concepts/deduplicating-stamps) across addresses.
