...
We also make an endpoint available to developers to pull, analyze, and build with GTC staking data.

We are specifically interested in having developers build solutions that help increase the amount of GTC staked on trusted entities to help us build out a trust graph.
