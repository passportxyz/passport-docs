...
| Curate Stamps and weights                | Remove any Stamps that don’t make sense for your ecosystem, and adjust the remaining Stamp weights to better reflect your ecosystem’s needs.                                                                                                                                                                                                                                   |
...
|------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Custom URL path                                | This path element will be used in your branded dashboard’s unique URL, which is where your users will access it.                                                                                              | https://app.passport.xyz/#/verax/dashboard                                                                                                                            |
| Partner name                                   | This will be used in a few different locations throughout the dashboard.                                                                                                                                      | Avalanche                                                                                                                                                             |
...
You can find the current Passport Stamp weights in the following link:

[How the Passport score is calculated](https://support.passport.xyz/passport-knowledge-base/common-questions/how-is-gitcoin-passports-score-calculated)
