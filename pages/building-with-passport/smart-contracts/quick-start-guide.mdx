...
The Gitcoin decoder contract ABI can be found on both block explorers and the [Gitcoin Github](https://github.com/passportxyz/eas-proxy/blob/main/deployments/abi/GitcoinPassportDecoder.json). 
...
If you have mroe questions you can chat in our [developer support channel on Telegram](https://t.me/+Mcp9RsRV7tVmYjZh).
