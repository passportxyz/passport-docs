...
description: Quick start gide to get you up and runnign with Passport XYZ's smart contracts.
---

# Smart contract quick start

The Passport XYZ smart contracts are deployed on several chains, covering both testnets and live networks. 
There are several contracts that interact with each other to provide the Passport XYZ backend and API. 
...
Explore our [contract reference page](./contract-reference.mdx) to find all the details about the various Passport XYZ contract deployments. 
