...
* Assuming the user didn’t pass primary verification, retrieve the user’s Stamp-based Unique Humanity Score from the Passport API v2 using the [`GET /v2/stamps/{scorer_id}/score/{address}`](../passport-api/api-reference#retrieve-latest-score-for-a-single-address) endpoint.
