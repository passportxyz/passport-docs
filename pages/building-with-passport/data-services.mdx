...
Passport’s Data Services offer batch analysis of wallet addresses, designed specifically for scenarios where you have a predefined list of addresses (such as airdrops, event registrations, or community campaigns). It complements Passport’s real-time verification tools like [Passport API](https://docs.passport.xyz/building-with-passport/passport-api/overview) and [smart contract-based verification](https://docs.passport.xyz/building-with-passport/smart-contracts/overview).
