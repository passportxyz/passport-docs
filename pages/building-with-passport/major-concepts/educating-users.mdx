...
1. You benefit from [Stamp weights](https://github.com/gitcoinco/passport-scorer/blob/main/api/scorer/settings/gitcoin_passport_weights.py) that have been assigned by Gitcoin data scientists.
