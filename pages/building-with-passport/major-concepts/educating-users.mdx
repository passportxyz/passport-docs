...
| Platform Integrator | Ecosystem Partner                                            | End user                                                      | Why the Platform integrating Passport XYZ is a win for everyone                       |
| ------------------- | ------------------------------------------------------------ | ------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
...
1. You benefit from [Stamp weights](https://github.com/passportxyz/passport-scorer/blob/main/api/scorer/settings/gitcoin_passport_weights.py) that have been assigned by Passport XYZ data scientists.
...
Passport XYZ is already protecting many real world applications! There are several use case articles on the [Gitcoin blog](https://www.gitcoin.co/blog/tag/case-studies) where you can read about how various apps have integrated Passport.
...
* You can explore this site!
  * Learn more about the [major concepts](../major-concepts.md) underpinning Passport XYZ
