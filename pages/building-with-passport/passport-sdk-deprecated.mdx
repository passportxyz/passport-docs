...
We have stopped supporting the SDK and begun the process of deprecating it.

Gitcoin recommends using the [**Passport API**](api-reference) going forward. 
</Callout>
...
For more information on [Gitcoin Passport](https://app.gitbook.com/o/Aqbtj6s4OkLaygileCka/s/ttgfRNVjO2DcVvUNyst9/) or to interact with a live instance, please visit the [Passport app](https://passport.gitcoin.co/).
