...
**Please note:**<br />This tutorial uses the Passport API v1. We recommend using [Passport API v2](/building-with-passport/stamps/passport-api) for new projects.<br /><br />We plan to update this tutorial to use Passport API v2 shortly.
</Callout>
