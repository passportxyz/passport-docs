---
title: Getting access to the Models API
description: Explainer for how to get access to the Models API.
---
...
<Callout type="info">
Please note:<br /><br />You do not need a Scorer or Scorer ID to use the Models API.
</Callout>
...
4. **Store your API key securely:** Store your API key in a secure place, as it will be used to access the Models API as well as the Passport API.
