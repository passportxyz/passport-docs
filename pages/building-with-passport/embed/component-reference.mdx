...
To review a more in-depth example, see our [tutorial](/building-with-passport/stamps/passport-embed/tutorials/protecting-sensitive-programs-with-passport-embed) or check out our complete [sample application](https://passport-sample-embed-demo.vercel.app) with [source code](https://github.com/passportxyz/passport-sample-embed-demo).
