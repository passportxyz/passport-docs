---
title: Gating acces with Human Passport
description: Tutorial covering how to gate access to your app using Human Passport.
---
...
In this guide, you'll learn how to gate an application using Human Passport. Specifically, you will:
...
<Cards>
  <Card title="Build Your First Sybil-Resistant Web App with Human Passport & Next.js" href="https://www.youtube.com/watch?v=bfkalDSvRDc" />
...
This simple example demonstrates the principles you would use to gate a real app using Human Passport.
...
It is recommended to use the Human Passport default Scorer. For now, this is the only option for server-side score calculations, but you can choose whether you wish the server to return an integer value (0-100) or return a Boolean (0 or 1). This is selected when you create the instance of the Scorer at [developer.passport.xyz](https://www.developer.passport.xyz).
