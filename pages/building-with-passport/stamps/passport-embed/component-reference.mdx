...
Please refer to our [tutorial](/building-with-passport/stamps/passport-embed/tutorials/protecting-sensitive-programs-with-passport-embed) to see an example of how to use this hook with a request to the Passport API to confirm the score server-side (recommended for protecting sensitive programs).
