...
The widget can be [customized](/building-with-passport/stamps/passport-embed/customization) in a number of ways, including:
...
* [Tutorial: Protecting Sensitive Programs with Passport Embed](/building-with-passport/stamps/passport-embed/tutorial/protecting-sensitive-programs-with-passport-embed)
