...
* `VITE_PASSPORT_API_KEY`: Your API key for the Passport API (get this from [Passport Developer Portal](https://developer.passport.xyz/)). This is used via the backend to verify that the user's Passport scores is above the passing threshold.
...
- Learn how to [customize your Passport Embed](../customization)
- Learn how to [use the Passport API](/building-with-passport/stamps/passport-api/overview)
