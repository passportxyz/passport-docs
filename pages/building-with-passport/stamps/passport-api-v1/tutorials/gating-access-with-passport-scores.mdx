...
To follow this tutorial, you'll need [Next.js](https://nextjs.org/), [Node](https://nodejs.org/en), and [Chakra-UI](https://chakra-ui.com/) installed on your machine. We will also be using the [Passport API](../scorer-api/).
...
* How to submit a Passport to the Passport XYZ registry using the Passport API
