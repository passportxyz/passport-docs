...
| zkEmail (coming soon)     | **total**                                                    |      4.000 |
...
| zkEmail      | ZKEmail#AmazonCasualPurchaser, ZKEmail#AmazonRegularCustomer, ZKEmail#AmazonHeavyUser, ZKEmail#UberOccasionalRider, ZKEmail#UberRegularRider, ZKEmail#UberPowerUser8             | Adding                  | Coming soon   | We are working on adding the zkEmail Stamp, which will be available in the coming weeks |
