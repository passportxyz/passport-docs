...
In the coming months, we are prioritizing additions, subtractions, and updates to the Passport Stamp lineup that will help enable users who are new to web3, users from more global regions, and low-income users to more easily verify their identity and participate in the Passport ecosystem.

| Stamp        | Credential                                | Action                  | Date          | Details         |
|--------------|-------------------------------------------|-------------------------|---------------| ----------------|
| LinkedIn     | LinkedIn                                  | Updating                | TBD           | We have identified a stronger criteria set for this Stamp that will increase the quality of the human signal, meaning that we'll also be increasing the weight of the Stamp. |
| Discord      | Discord                                   | Updating                | TBD           | We have identified a stronger criteria set for this Stamp that will increase the quality of the human signal, meaning that we'll also be increasing the weight of the Stamp. |
...
| X (Twitter)  | TBD                                       | Adding                  | TBD           | We are re-adding a X (Twitter) Stamp. We've identified a stronger criteria set for this Stamp, which we previously removed in early 2024, and will be launching it with increased weight. |
| Steam        | TBD                                       | Adding                  | TBD           | We are planning to add a new Steam Stamp, which awards points for gaming activities. |
| Idena        | IdenaState#Newbie, IdenaState#Verified, IdenaState#Human | Removing                | TBD           | We are planning to remove the Idena Stamp soon. We've identified that this Stamp is too difficult for users to achieve, and the effort to maintain it was not sustainable for the Passport ecosystem. |
| BrightID     | Brightid                                  | Removing                | TBD           | We are planning to remove the BrightID Stamp soon. The effort to maintain, along with the lack of quality human signal, was not sustainable for the Passport ecosystem. |
| Coinbase     | CoinbaseDualVerification                  | Re-adding               | Coming soon   | We are re-adding the Coinbase Dual Verification Stamp, which was removed in February 2025, but with a reduced weight |
