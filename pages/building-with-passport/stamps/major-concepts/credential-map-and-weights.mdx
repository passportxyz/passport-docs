...
*These weights were last updated July 2025 -- See [Stamp Changelog](#stamp-changelog) for more details*
...
| zkEmail      | Amazon -- Tier 1                                             |      1.000 |
| zkEmail      | Amazon -- Tier 2                                             |      0.600 |
| zkEmail      | Amazon -- Tier 3                                             |      0.400 |
| zkEmail      | Uber -- Tier 1                                               |      1.000 |
| zkEmail      | Uber -- Tier 2                                               |      0.600 |
| zkEmail      | Uber -- Tier 3                                               |      0.400 |
...
| zkEmail      | Amazon -- Tier 1                          | Added                   | Coming soon   | We are working on adding the zkEmail Stamp, which will be available in the coming weeks |
| zkEmail      | Amazon -- Tier 2                          | Added                   | Coming soon   | We are working on adding the zkEmail Stamp, which will be available in the coming weeks |
| zkEmail      | Amazon -- Tier 3                          | Added                   | Coming soon   | We are working on adding the zkEmail Stamp, which will be available in the coming weeks |
| zkEmail      | Uber -- Tier 1                            | Added                   | Coming soon   | We are working on adding the zkEmail Stamp, which will be available in the coming weeks |
| zkEmail      | Uber -- Tier 2                            | Added                   | Coming soon   | We are working on adding the zkEmail Stamp, which will be available in the coming weeks |
| zkEmail      | Uber -- Tier 3                            | Added                   | Coming soon   | We are working on adding the zkEmail Stamp, which will be available in the coming weeks |
