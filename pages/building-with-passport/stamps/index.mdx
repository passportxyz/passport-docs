...
* **[Passport API v2](/building-with-passport/stamps/passport-api):** Retrieves the Stamp-based Unique Humanity Score and associated metadata for a specified address. 
...
* **[Passport Embed](/building-with-passport/stamps/passport-embed):** A widget that can be embedded on a website or app to allow users to verify their identity.
...
<Cards>
  <Card title="Overview" href="/building-with-passport/stamps/passport-api" />
...
<Cards>
  <Card title="Passport Embed" href="/building-with-passport/stamps/passport-embed" />
</Cards>
...
<Cards>
  <Card title="Overview" href="/building-with-passport/stamps/smart-contracts" />
