...
<Cards>
  <Card title="Generate API Key and Scorer ID" href="/building-with-passport/stamps/passport-api/getting-access" />
</Cards>
...
<Cards>
  <Card title="Onchain Passport" href="/building-with-passport/stamps/smart-contracts" />
</Cards>
