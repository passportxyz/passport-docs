...
* **Data dictionary:** For definitions of the data types used in Passport API v2, see the [Data dictionary](/building-with-passport/stamps/major-concepts/data-dictionary) page.
