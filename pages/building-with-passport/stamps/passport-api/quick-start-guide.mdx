...
It's worthwhile to note that you can manually set your own [score threshold](../major-concepts/scoring-thresholds) within your code base based on your ecosystem's unique needs, but a score threshold of 20 is recommended for optimal results.
