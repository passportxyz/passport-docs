...
Passport Stamps data is made available via the [Passport API](building-with-passport/passport-api). Users can optionally push their Passport Stamps data onchain, which can be accessed by developers using our [smart contracts](building-with-passport/smart-contracts).

The core Passport Stamps offering is free, but additional premium add-ons ([Custom Passport](building-with-passport/custom-passport) and [Passport Embed](building-with-passport/passport-embed)) can be added to your integration to reduce user friction and customize your unique human verification experience.
