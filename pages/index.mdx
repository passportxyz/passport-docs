...
The model scores made available by the [Models API](building-with-passport/models/introduction) are generated using Human Passport's machine learning models that analyze address onchain activity on ETH L1 and several L2s, and compares that activity against the activity of massive lists of known Sybils and humans. 
...
<Cards>
  <Card title="Verify with Passport Models" href="building-with-passport/models/introduction" />
</Cards>
