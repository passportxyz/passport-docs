...
Passport Stamps data is made available via the [Stamps API](building-with-passport/passport-api). Users can optionally push their Passport Stamps data onchain, which can be accessed by developers using our [smart contracts](building-with-passport/smart-contracts).
